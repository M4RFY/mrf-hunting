print("^2Mrf^7-^2Hunting v^41^7.^40 ^7- ^2Hunting Script by ^1Marfy^7")
Config = Config or {}
...
-- note: in my tests if it's true you need to restart QB-target first and then mrf-hunting afterward
